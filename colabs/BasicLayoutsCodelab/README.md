...
## Quick Note About Modifiers
When writing composable, you use modifiers to:

- Change the compatible's size, layout, behavior, and appearance.
- Add information, like accessibility labels.
- Process user input.
- Add high-level interactions, like making an element clickable, scrollable, draggable, or zoomable.
Each composable that you call has a modifier parameter that you can set to adapt that compatible's look, feel and behavior. 
When you set the modifier, you can chain multiple modifier methods to create a more complex adaptation.